...
contract Diskify is ERC1155 {
    ...
    address public constant owner = 0xCD109A076466EFf8e224a3a10619f54b7e4ce2f1; 
    ...
    ) external payable hasAlbum(_to, _album_id, true) isBlocked(_album_id) returns(bool) 
    {
        ...
        _owner.transfer(_diskify_share);
        _artist.transfer(_artist_share);
        _to.transfer(_nft_owner_share);
